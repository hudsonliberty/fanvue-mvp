...
const CLIENT_SECRET = process.env.CLIENT_SECRET || 'replace_with_your_secret';
...
app.listen(PORT, () => {
  console.log('='.repeat(60));
  console.log('FANVUE SERVER RUNNING ON RENDER');
  console.log('='.repeat(60));
  console.log(`Server running on port ${PORT}`);
  console.log(`Access URL: https://fanvue-proxy2.onrender.com`);
  console.log(`OAuth Start URL: https://fanvue-proxy2.onrender.com/oauth/start`);
  console.log('='.repeat(60));
});
